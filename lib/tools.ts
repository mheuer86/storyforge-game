        ...
        properties: {
          add_npcs: {
            ...
            items: {
              ...
              properties: {
                ...
                retrieval_cue: { type: 'string', description: 'One-line relevance pointer: when does this NPC matter to pull back into a scene? Example: "knows the Maren case" or "controls the dock access permits". Stage 2 measurement: missing values are logged.' },
              },
          ...
          add_threads: {
            ...
            items: {
              ...
              properties: {
                ...
                retrieval_cue: { type: 'string', description: 'One-line relevance pointer: when does this thread become worth pulling back into a scene? Example: "knows the Maren case" or "holds the only copy of the contract". Stage 2 measurement: missing values are logged.' },
              },
          ...
          add_faction: {
            ...
            properties: {
              name: { type: 'string' },
              stance: { type: 'string' },
              retrieval_cue: { type: 'string', description: 'One-line relevance pointer: when does this faction matter in a scene? Example: "whenever PC is in Synod-aligned territory" or "if heat rises on compliance enforcement". Stage 2 measurement.' },
            },
          ...
          add_promise: {
            ...
            properties: {
              ...
              retrieval_cue: { type: 'string', description: 'One-line relevance pointer: when should this promise surface in a scene? Example: "whenever Bishop is present" or "as pressure on Oriane reaches breaking point". Stage 2 measurement.' },
            },
          ...
          add_decision: {
            ...
            properties: {
              ...
              retrieval_cue: { type: 'string', description: 'One-line relevance pointer: what future scene should recall this decision? Example: "when an NPC tests whether you will honor the promise" or "any scene involving the Iron Syndicate". Stage 2 measurement.' },
            },
          ...
          add_clues: {
            ...
            items: {
              ...
              properties: {
                ...
                retrieval_cue: { type: 'string', description: 'One-line pointer: when does this clue become relevant in a scene? Example: "when the PC returns to the crash site" or "whenever a Synod agent appears". Stage 2 measurement.' },
              },
        ...
        properties: {
          create_arc: {
            ...
            properties: {
              ...
              retrieval_cue: { type: 'string', description: 'One-line pointer to when this arc becomes the chapter\'s load-bearing context. Example: "any chapter that tests whether the PC remembers the dead" or "when the Architect\'s network threatens new Resonants". Stage 2 measurement.' },
            },
