        ...
        addNpcs: {
          ...
          items: {
            ...
            properties: {
              ...
              voiceNote: { type: 'string', description: 'Speech rhythm in one line. E.g. "Short sentences. Grunts. Mechanical metaphors." or "Measured, analytical, qualifies everything."' },
              combatTier: { type: 'number', enum: [1, 2, 3, 4, 5], description: 'Threat tier for stat derivation. Set once. 1=civilian, 2=trained, 3=veteran, 4=elite, 5=apex.' },
              combatNotes: { type: 'string', description: 'Fighting style and tactical behavior. E.g. "tactical, focuses fire, won\'t fight alone"' },
            },
        ...
        updateNpc: {
          ...
          properties: {
            ...
            status: { type: 'string', enum: ['active', 'dead', 'defeated', 'gone'], description: 'Set when an NPC is permanently removed from play.' },
              voiceNote: { type: 'string', description: 'Update speech rhythm.' },
              combatTier: { type: 'number', enum: [1, 2, 3, 4, 5], description: 'Set threat tier.' },
              combatNotes: { type: 'string', description: 'Update fighting style.' },
          },
          required: ['name'],
        },
        setLocation: {
