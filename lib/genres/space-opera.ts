...
**Corridor Law.** In charted space, law exists in proportion to the nearest faction's ability to enforce it. Remnant patrols mean Compact law. Corporate sectors mean corporate law. The frontier means reputation and firepower.`,
  ...
  openingHooks: [
    ...
    { hook: 'A Compact-era admiral reactivates a mothballed battle group and calls human captains to "restore order." She offers commissions, supplies, and legitimacy; the frontier settlements in her path call it invasion. Your crew is split, and the admiral knows your name because she wants your ship to make conquest look like reunion.', title: 'The Restoration', origins: ['human'], frame: { objective: 'Decide whether the admiral is rebuilding protection, empire, or a story that needs your name', crucible: 'A charismatic fleet, threatened settlements, and a crew divided over whether order is worth force' }, arc: { name: 'The Restoration', episode: 'Make the admiral, frontier representative, and divided crew reveal what restoration would do to the first target' } },
