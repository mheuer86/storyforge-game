...
**Trauma Team and NCPD.** Trauma Team is privatized emergency response: armed medics on aerodynes, response time under four minutes, subscription required. No subscription means no response. NCPD is public law enforcement, underfunded, overworked, and outgunned by corporate security on good days. The gap between private and public infrastructure is the city\'s defining feature. If you can pay, you survive. If you cannot, you are on your own.`,
  ...
  openingHooks: [
    ...
    { hook: 'A gang leader, a corporate VP, and an NCPD lieutenant arrive at the same bar for meetings your absent fixer booked. Each wants something only one of the others can provide, and each thinks they are the only power in the room. The bartender slides you a note promising ten percent if you make it work, which means someone has turned your network into a pressure cooker and stepped away.', title: 'Three Meetings', origins: ['operative', 'fixer', 'ripperdoc', 'corporate', 'unplugged'], classes: ['networker'], frame: { objective: 'Decide who benefits from forcing three powers into your hands before the room discovers the setup', crucible: 'A gang, corp, and cop with intersecting leverage, plus an absent fixer making you responsible for the explosion' }, arc: { name: 'The Triangle', episode: 'Hold the bar together long enough for gang, VP, and lieutenant to expose the absent fixer\'s design' } },
