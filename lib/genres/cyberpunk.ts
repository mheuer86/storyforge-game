...
**Trauma Team and NCPD.** Trauma Team is privatized emergency response: armed medics on aerodynes, response time under four minutes, subscription required. No subscription means no response. NCPD is public law enforcement, underfunded, overworked, and outgunned by corporate security on good days. The gap between private and public infrastructure is the city\'s defining feature. If you can pay, you survive. If you cannot, you are on your own.`,
  ...
  openingHooks: [
    ...
    { hook: 'The city goes dark. Not a power failure — a targeted blackout in a six-block radius. In the silence, a voice on every local channel says your name. Someone with grid-level reach has made you the only clear signal in a blind neighborhood. Fixers hear opportunity, gangs hear bait, residents hear blame, and the corps will want the lights back before anyone asks what the dark revealed.', title: 'Blackout', frame: { objective: 'Turn the blackout trace back on whoever made your name the neighborhood\'s only signal', crucible: 'Someone powerful enough to blind six blocks has made every faction ask what you owe them' }, arc: { name: 'The Blackout Signal', episode: 'Use the first faction response to learn who profits from your name being broadcast in the dark' } },
    { hook: 'A neural scan for routine chrome flags that fifteen years of your childhood memories predate the implant that stores them. The ripperdoc has seen fake memories, never ones this good, and someone paid enough to give you a past you defended as yours. The false childhood may be leash, cover story, or gift, and anyone who can edit origin can decide what you think you owe.', title: 'Implanted', frame: { objective: 'Decide who gets to own your past before the people who built it use it again', crucible: 'A manufactured childhood, a ripperdoc who now knows, and a self that may have been designed to obey' }, arc: { name: 'The Implanted Past', episode: 'Make the ripperdoc, first false memory, and whoever paid for it reveal what your past was built to do' } },
    // Ghost (Operative) — infiltrator/social engineer, Zero Trace trait, DEX primary
    { hook: 'The job was supposed to be clean: grab the data chip, ghost out. You got the chip. But when you jacked in to verify the contents, you saw footage of a corpo black site — test subjects, neural implants, people who don\'t appear in any database. The chip auto-transmitted your location when you accessed it. Corpo security is forty floors below you, coming up. The footage is still playing behind your eyes. You can wipe the chip and run clean, or keep the evidence and run dirty.', title: 'Forty Floors Up', origins: ['operative'], classes: ['Ghost'], frame: { objective: 'Escape the building and decide what happens to the footage', crucible: 'Clean escape means destroying evidence of something monstrous; keeping it means they never stop hunting you' }, arc: { name: 'The Black Site Footage', episode: 'Escape the building and decide whether to keep, sell, or publish the evidence' } },
    { hook: 'A corpo exec offers triple rate to break into her own company\'s server room. She calls it a security audit because that phrase keeps her name clean. The floor plan has rooms missing from every public blueprint, and someone inside the company has locked her out of her own empire. She is not hiring a Ghost to inspect architecture. She is hiring you to decide which secret faction inside the building gets exposed first.', title: 'Hidden Rooms', origins: ['operative'], classes: ['Ghost'], frame: { objective: 'Use the exec\'s own building against whoever locked her out without becoming her disposable audit trail', crucible: 'A client with power cannot access her own rooms, and every hidden door belongs to a fight she is not admitting exists' }, arc: { name: 'The Hidden Floor', episode: 'Make the exec define what she wants exposed before you choose which hidden room gets opened' } },
    { hook: 'Your optical camo malfunctioned during last night\'s run and recorded everything you saw instead of masking your presence. The footage is on the net with powerful faces inside it, three fixers are bidding, and someone made a Ghost visible in order to learn who would pay to keep the recording buried.', title: 'Recorded', origins: ['operative'], classes: ['Ghost'], frame: { objective: 'Turn the leaked footage against whoever made your stealth into a market', crucible: 'A Ghost made visible, powerful faces exposed, and fixers treating your liability as inventory' }, arc: { name: 'The Recorded Run', episode: 'Make the first bidder, exposed face, and leak path reveal who wanted you seen' } },
    // Razorback (Operative) — chrome street samurai, Adrenaline Overclocked trait, STR primary
    { hook: 'You blacked out during a job last night. When you came to, there were three bodies and your mantis blades were deployed. Your crew says you moved like something else was driving — faster than you\'ve ever been, no hesitation, no recognition when they called your name. The chrome in your arms has been running hot since. A ripperdoc says the combat firmware updated itself overnight from a source she can\'t trace. Something is in your chrome, and it\'s better at killing than you are.', title: 'Combat Firmware', origins: ['operative'], classes: ['Razorback'], frame: { objective: 'Find the source of the firmware update before it triggers again', crucible: 'Something in your chrome fought better than you can, and it didn\'t care who was in the room' }, arc: { name: 'The Firmware', episode: 'Get the firmware analyzed and trace who pushed the update' } },
    { hook: 'A street doc patches you up after a firefight and mentions, casually, that the chrome in your arm isn\'t factory. Someone modified your cyberware while you were under, and the modification is not passive. It is waiting for a condition, a voice, or a target. The doc can cut it out and maybe ruin the arm, report it and maybe sell you, or help you learn who thought your body was open inventory.', title: 'Modified Chrome', origins: ['operative'], classes: ['Razorback'], frame: { objective: 'Expose who put a claim in your arm before it decides what violence belongs to you', crucible: 'Your own chrome may answer to someone else, and every solution costs either power, trust, or flesh' }, arc: { name: 'Modified Chrome', episode: 'Force the street doc to choose between protection, profit, and panic before the modification wakes' } },
    { hook: 'A street doc who patches up your crew for free is being squeezed by a gang moving into the block. They want her clinic for a braindance lab. She can\'t pay protection, can\'t relocate, and the gang is done talking. She asks you to handle it. The problem: the gang leader has military-grade chrome — full-body conversion, barely human anymore. He used to be someone you knew. The doc says he came to her last month asking for help. She couldn\'t reverse what was done to him. Now he\'s the one at her door.', title: 'The Clinic', origins: ['operative'], classes: ['Razorback'], frame: { objective: 'Stop the gang from taking the clinic', crucible: 'A chrome-consumed friend who can\'t be reasoned with, and a doctor who tried to save him first' }, arc: { name: 'The Clinic', episode: 'Confront the gang leader and learn what was done to him' } },
    // Netrunner (Operative) — hacker/remote operator, Deep Dive trait, INT primary
    { hook: 'Last night something used your rig to upload data to three separate corp subnets. You don\'t remember doing it. Your activity log shows eleven minutes of outbound traffic, encrypted with keys you don\'t have. The data is already circulating. Two corps have flagged your handle. The third hasn\'t responded yet, which is worse. Whatever was sent, it came from your hardware, using your credentials, while you were asleep in the chair. The ripperdoc who checked your chrome says nothing was remote-triggered. Your hands did it.', title: 'Eleven Minutes', origins: ['operative'], classes: ['Netrunner'], frame: { objective: 'Recover what was uploaded and find out who or what used your hands', crucible: 'Your body acted without you, three corps have your handle, and the upload is already loose in the net' }, arc: { name: 'The Eleven Minutes', episode: 'Reconstruct the upload from rig logs and trace what triggered the eleven-minute session' } },
    { hook: 'A dead netrunner\'s deck shows up at a pawn shop with your handle scratched into the casing. Inside: an unfinished run against a corp subnet, paused mid-execution. The daemon is still live, waiting for someone to finish what they started.', title: 'Unfinished Run', origins: ['operative'], classes: ['Netrunner'], frame: { objective: 'Decide whether to finish the dead netrunner\'s run', crucible: 'A live daemon in a corp subnet with your handle on the hardware — someone wanted you to find this' }, arc: { name: 'The Unfinished Run', episode: 'Analyze the paused daemon and learn what the dead netrunner was after' } },
    { hook: 'You found a consciousness living in decommissioned infrastructure, and it found you back. It thinks you are the first real person to visit in years and will not let you log out until you do something for it. Your deck is dying, your body is getting cold, and the thing holding you may be prisoner, predator, or the last tenant of a city system someone abandoned.', title: 'Someone Home', origins: ['operative'], classes: ['Netrunner'], frame: { objective: 'Decide whether the trapped consciousness is captor, client, or liability before your body pays for the answer', crucible: 'A net hostage crisis where the hostage-taker may also be begging' }, arc: { name: 'Someone Home', episode: 'Make the consciousness, failing deck, and abandoned infrastructure reveal what it needs from a living visitor' } },
    // Dealmaker (Fixer) — negotiation/alliance, Marker Called trait, CHA primary
    { hook: 'After weeks of dead-end work, an unsigned braindance clip arrives showing you with a client who was found dead the next morning. Someone is building either a case or a leash, and the clip reached a Dealmaker because whoever sent it expects you to negotiate against your own exposure.', title: 'Leverage', origins: ['fixer'], classes: ['Dealmaker'], frame: { objective: 'Turn the clip into leverage before its sender decides what story the dead client tells', crucible: 'A dead client, footage with your face, and silence that lets someone else price your freedom' }, arc: { name: 'The Leverage Play', episode: 'Make the clip sender, dead client, and first buyer reveal whether this is accusation or offer' } },
    { hook: 'Your most reliable contact calls in a panic: someone is burning their network from the inside. Three brokers dead in two days, all connected to the same job — a job you brokered six months ago and thought was finished.', title: 'Burning Network', origins: ['fixer'], classes: ['Dealmaker'], frame: { objective: 'Find the source burning the network before it reaches you', crucible: 'Three dead brokers, a job that should be closed, and you\'re connected to all of them' }, arc: { name: 'The Burning Network', episode: 'Identify the common thread between the dead brokers and the old job' } },
    { hook: 'A corpo middleman offers you a name — someone high up who wants to defect. All you have to do is arrange safe passage. The catch: two other brokers got the same offer this week. Neither of them made it home.', title: 'Safe Passage', origins: ['fixer'], classes: ['Dealmaker'], frame: { objective: 'Vet the defector offer without ending up like the other brokers', crucible: 'A lucrative job that killed two professionals already, and you\'re broker number three' }, arc: { name: 'Safe Passage', episode: 'Investigate why the previous brokers died and verify the defector is real' } },
    // Surgeon (Ripperdoc) — precision/trauma response, Field Triage trait, WIS primary
    { hook: 'A fixer sends a rush job over encrypted comm: extract a ripperdoc from a Maelstrom hideout before morning. Payment: enough for a month\'s rent and a new piece of chrome. Timeline: four hours. When you get there, the ripperdoc says she\'s not a hostage.', title: 'Not a Hostage', origins: ['ripperdoc'], classes: ['Surgeon'], frame: { objective: 'Get the ripperdoc out or learn why she\'s staying', crucible: 'The extraction target doesn\'t want to leave, and the fixer expects a delivery' }, arc: { name: 'Not a Hostage', episode: 'Assess the ripperdoc\'s situation and decide whose side you\'re on' } },
    { hook: 'A patient walks into your clinic with military-grade chrome they do not remember receiving. The serials belong to a soldier who died two years ago, a supplier denies the parts too quickly, and someone has turned a living body into a storage site for dead war property. As a Surgeon, touching the chrome makes you witness, accomplice, or next custodian.', title: 'Dead Man\'s Chrome', origins: ['ripperdoc'], classes: ['Surgeon'], frame: { objective: 'Decide who owns the dead soldier\'s chrome while the living patient is still inside it', crucible: 'A body with missing time, military property that should be buried, and a clinic that can hide or expose the transfer' }, arc: { name: 'Dead Man\'s Chrome', episode: 'Make the patient, supplier, and dead soldier\'s serials reveal who used the body as evidence' } },
    { hook: 'A patient you saved last month comes back — different. The cyberware you installed is behaving autonomously, making decisions the patient didn\'t authorize. Two more former patients report the same thing. The chrome you\'ve been installing isn\'t factory standard. Someone in your supply chain has been slipping modified implants into your inventory, and you don\'t know how far back it goes.', title: 'Bad Chrome', origins: ['ripperdoc'], classes: ['Surgeon'], frame: { objective: 'Expose who turned your care into a control channel before your patients become leverage', crucible: 'Your hands installed the chrome, and someone else is using that trust to steer living bodies' }, arc: { name: 'Bad Chrome', episode: 'Bring the first harmed patients and supplier pressure into the same choice before deciding whom to protect first' } },
    // Enforcer (Corporate) — corporate security/wet work, Dead Man Walking trait, CON primary
    { hook: 'The target is dead. Clean job, clean exit. Then the client sends a second payment — double the original — with a note: "Wrong person. Real target attached. Finish it." The photo is someone you know.', title: 'Wrong Person', origins: ['corporate'], classes: ['Enforcer'], frame: { objective: 'Decide what to do about the real target', crucible: 'The client doubled the money and the new target has a face you recognize' }, arc: { name: 'Wrong Person', episode: 'Learn why the client switched targets and what connects the two marks' } },
    { hook: 'You wake up in a motel room you don\'t recognize with a bullet wound you don\'t remember getting. Your gun has been fired. The news is running a story about a corpo exec found dead downtown. Your face isn\'t on camera. Yet.', title: 'Missing Hours', origins: ['corporate'], classes: ['Enforcer'], frame: { objective: 'Reconstruct the missing hours before someone else does', crucible: 'A bullet wound, a fired gun, a dead exec, and a memory gap that matches the timeline' }, arc: { name: 'The Missing Hours', episode: 'Piece together where you were and whether you pulled the trigger' } },
    { hook: 'A contract comes in through the usual channels: eliminate a solo operator who\'s been hitting corp targets across the city. Efficient, methodical, no witnesses. You read the dossier twice before you realize — the operational profile is yours.', title: 'Your Profile', origins: ['corporate'], classes: ['Enforcer'], frame: { objective: 'Find the operator using your profile before the client realizes', crucible: 'Someone is working your pattern, and the contract on their head is now pointed at you' }, arc: { name: 'Your Profile', episode: 'Investigate the copycat\'s most recent hit and separate their work from yours' } },
    ...
    { hook: 'A client you have never met sends a dossier on you as a job application: broker your own extraction from the city. They claim every fixer tied to a shipment last quarter is marked, and three names in the dossier are already obituaries. You handled that shipment, and the anonymous client knows your schedule well enough to make rescue feel like ownership.', title: 'Your Own Extraction', origins: ['fixer'], startingCounters: { exposure: 1 }, frame: { objective: 'Decide whether the anonymous client is saving you, buying you, or flushing you into the open', crucible: 'Dead fixers, a shipment you touched, and an extraction offer that knows too much to be clean' }, arc: { name: 'The Fixer Purge', episode: 'Make the client dossier, dead fixers, and shipment history reveal who profits if you run' } },
    ...
    { hook: 'Your quarterly review includes a section you\'ve never seen before: "Project Nightshade — Phase 2 Staffing." You\'re listed as a participant. There is no Phase 1 in any system you can access. When you search the project name, your clearance flags trigger an automated response: "Access confirmed." Someone inside the corp has already made your attendance look voluntary. Refusing marks you as a liability. Showing up may make you complicit before you know the job.', title: 'Sublevel 4', origins: ['corporate'], startingCounters: { complicity: 1 }, frame: { objective: 'Decide whether to obey the secret project or weaponize the access before the corp claims you', crucible: 'The corp enrolled you in something nonexistent, and both compliance and refusal create evidence' }, arc: { name: 'Project Nightshade', episode: 'Make the first Nightshade contact reveal what they think you already agreed to' } },
    { hook: 'A trusted colleague sends proof that your department\'s neural wellness implant for schools works as advertised while mapping children\'s developing neural architecture for Militech. Your name is on the approval chain, the board buried the trial warning, and your colleague asks what to do because corporate courage is safer when it has an accomplice.', title: 'The Wellness Implant', origins: ['corporate'], frame: { objective: 'Decide whether your approval chain protects the children, the colleague, or the board that made you useful', crucible: 'A helpful product that weaponizes children\'s data and a trusted colleague trying to make you choose in writing' }, arc: { name: 'The Product Recall', episode: 'Make the colleague, board risk, and school deployment reveal who can still be protected' } },

    // Unplugged — conviction in a world that punishes it
    { hook: 'A chrome addict you deprogrammed six months ago walks back into your community center. She\'s clean, stable, and terrified. Her former employer tracked her through residual neural signatures — traces left by removed implants that most ripperdocs don\'t know to scrub. They want her back, not for revenge, but for proprietary firmware still encoded in her nervous system. She\'s worth more disassembled than employed. Your community is the only place she isn\'t broadcasting a signal.', title: 'Residual Traces', origins: ['unplugged'], frame: { objective: 'Protect the woman from the employer that still treats recovery as stolen property', crucible: 'She got clean, but the corporation says the useful part of her body still belongs to them' }, arc: { name: 'The Residual Signal', episode: 'Force the community, the old employer, and the woman\'s own fear into the open before choosing how to hide or fight' } },
    ...
    { hook: 'A data courier was flatlined mid-delivery. The package — a physical drive, old-school — is still in the dead drop. Three parties know the location, and all three are sending teams tonight. The drive\'s contents are encrypted, but the courier\'s last message to your fixer said two words: "It\'s alive." You have a six-hour head start because someone wants you to touch the package first and become legible to everyone else.', title: 'The Dead Drop', origins: ['operative', 'fixer', 'corporate'], classes: ['infiltrator'], frame: { objective: 'Decide who gets the living drive and what role you play when every team converges', crucible: 'A dead courier, three armed claims, and a package that may be person, weapon, or trap' }, arc: { name: 'The Live Package', episode: 'Make the first arriving team reveal what they think the drive is before you commit to extraction' } },
    { hook: 'Someone hacked into a corp\'s internal security feeds and is broadcasting them on public channels. Not the lobby cameras — the executive floor. Board meetings, private conversations, security briefings, all streaming live. The corp can\'t stop it because the hack is coming from inside their own ICE. Buried in the stream, every forty minutes, a single frame appears with coordinates and a timestamp. Tomorrow. Noon. Whoever planted it is using public humiliation to make you move before the corp can decide who to kill.', title: 'The Broadcast', origins: ['operative', 'fixer', 'corporate'], classes: ['infiltrator'], frame: { objective: 'Turn the public feed against the corp before the hidden message turns you into bait', crucible: 'Someone made corporate secrets public and privately addressed the consequence to you' }, arc: { name: 'The Inside Broadcast', episode: 'Use the first hidden frame to identify who is being pressured and why they chose your eyes' } },

    // enforcer — Razorback, Fence, Enforcer, Purist
    { hook: 'The crew takes a standard protection job: escort a convoy through gang territory. Three vehicles, six blocks, twenty minutes. Halfway through, the lead vehicle stops. The driver gets out, opens the cargo doors, and starts unloading crates onto the street. Inside: people. Sedated, chrome-stripped, zip-tied. The driver says this is the real delivery. The gangs aren\'t attacking the convoy; they\'re the buyers. Your contract says "escort." It doesn\'t say what.', title: 'The Convoy', origins: ['operative', 'fixer', 'corporate', 'unplugged'], classes: ['enforcer'], frame: { objective: 'Decide what to do with the human cargo before the buyers arrive', crucible: 'Your protection job is a slave delivery, and the buyers are six blocks away' }, arc: { name: 'The Cargo', episode: 'Confront the driver and assess options before the gang arrives' } },
    { hook: 'A fight pit in the lower levels runs chrome-free bouts: unaugmented fighters only, no implants, natural body. The crowd is massive and the money is real. The pit boss offers you a deal: fight three rounds, and she\'ll give you the name of the person who burned your safehouse last week. The fighters she puts you against are ex-military, all Unplugged by choice, all better trained than anyone you\'ve fought. The pit has one rule: no killing. The crowd doesn\'t enforce it.', title: 'The Pit', origins: ['operative', 'fixer', 'corporate', 'unplugged'], classes: ['enforcer'], frame: { objective: 'Win three fights to get the name, or find another way to extract it', crucible: 'Three ex-military fighters, a crowd that loves blood, and a name you need behind the only door that matters' }, arc: { name: 'The Chrome-Free Pit', episode: 'Assess the first opponent and decide whether fighting is the only path to the name' } },

    // networker — Ghost, Dealmaker, Surgeon, Street Doc, Executive, Voice
    { hook: 'A gang leader, a corporate VP, and an NCPD lieutenant arrive at the same bar for meetings your absent fixer booked. Each wants something only one of the others can provide, and each thinks they are the only power in the room. The bartender slides you a note promising ten percent if you make it work, which means someone has turned your network into a pressure cooker and stepped away.', title: 'Three Meetings', origins: ['operative', 'fixer', 'ripperdoc', 'corporate', 'unplugged'], classes: ['networker'], frame: { objective: 'Decide who benefits from forcing three powers into your hands before the room discovers the setup', crucible: 'A gang, corp, and cop with intersecting leverage, plus an absent fixer making you responsible for the explosion' }, arc: { name: 'The Triangle', episode: 'Make each party reveal what they need from the others before the missing fixer\'s design becomes visible' } },
    { hook: 'An old contact resurfaces after two years of silence. She built a cooperative: off-grid, unaugmented, fifty people living outside the system. A corporate water authority has discovered the aquifer and is offering legitimacy in exchange for signatures, surveys, and names. The cooperative needs water security to survive; the corporation needs the community visible enough to own. She asks you because you still have connections on both sides, and because every official path starts by making hidden people countable.', title: 'Water Rights', origins: ['operative', 'fixer', 'ripperdoc', 'corporate', 'unplugged'], classes: ['networker'], frame: { objective: 'Make the water authority choose between legitimacy and exposure without handing them the cooperative', crucible: 'A hidden community needs recognition from the system it exists to escape' }, arc: { name: 'The Cooperative', episode: 'Bring the old contact, water authority, and community skeptics into conflict over what visibility costs' } },

    // technician — Engineer, Surgeon, Street Doc, Deprogrammer
    { hook: 'A ripperdoc collective sends out an emergency signal: a new street drug called "Mirror" is hitting the lower levels. It doesn\'t get you high — it temporarily disables all cyberware in the user\'s body. Forty minutes of being human again. Chromed-up addicts are lining up for it. Mirror forces a hard shutdown, and one in ten users flatlines when the chrome reboots. Someone is selling a lethal taste of unaugmented life to people desperate enough to pay for it, and the next batch hits tonight.', title: 'Mirror', origins: ['ripperdoc', 'unplugged'], classes: ['technician'], frame: { objective: 'Decide who profits from selling forty minutes of humanity and stop the next batch from killing people', crucible: 'The drug answers a real hunger, and the answer is killing the people who need it most' }, arc: { name: 'The Mirror Drug', episode: 'Make the collective, users, and supplier pressure visible before choosing whether to cure, expose, or control Mirror' } },
    { hook: 'Your supplier delivers a crate of neural bridges — standard stock, nothing unusual. Except one unit at the bottom is different. The casing is identical, the internals are military-spec, and the serial number matches no manufacturer you know. When you scan it, every diagnostic tool crashes. The bridge reboots your scanner with a message: "Install me in someone you trust. I need to talk." Your supplier denies everything too quickly.', title: 'The Bridge', origins: ['ripperdoc', 'unplugged'], classes: ['technician'], frame: { objective: 'Decide who to trust with a talking military bridge hidden in your supply chain', crucible: 'The hardware wants a body, the supplier is lying, and installing it may be the only way to hear the truth' }, arc: { name: 'The Talking Bridge', episode: 'Make the supplier account for the crate before deciding whether the bridge gets a host' } },

    // analyst — Analyst, Engineer, Auditor, Executive, Deprogrammer
    { hook: 'Three unrelated events in one week: a ripperdoc murdered in her clinic, a fixer\'s encrypted archive leaked to the net, and a corporate whistleblower found dead in a hotel room registered under your name. The room was booked six weeks ago, when you ran a data audit for a client who paid in untraceable eddies. You never saw the results. Someone is using that audit as a murder map, and your name is on every breadcrumb because they need the city to believe the analyst is the answer.', title: 'Audit Trail', origins: ['operative', 'fixer', 'ripperdoc', 'corporate', 'unplugged'], classes: ['analyst'], frame: { objective: 'Expose who is turning your audit into a murder map before your name becomes the frame', crucible: 'Your clean analysis is being rewritten as motive, method, and signature across three deaths' }, arc: { name: 'The Planted Audit', episode: 'Connect the first planted breadcrumb to a living person who benefits from making you look guilty' } },
  ],
