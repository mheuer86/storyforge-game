...
**The Gods.** The divine connection is thinning. Priests a generation ago spoke of clear visions, direct guidance, unmistakable presence. Current priests describe echoes, impressions, and the growing suspicion that the names they use for the gods may not be the right ones. Divine magic still functions, but it is weaker, less reliable, and increasingly conditional. The churches preach certainty they no longer feel. Some theologians believe the gods are dying. Others believe they are withdrawing. The Keepers, who hold the last threads of divine favor, know only that what answers their prayers is quieter each year.`,
  ...
  openingHooks: [
    ...
    { hook: 'A dwarven bridge that has stood for a thousand years collapses overnight. Not from erosion — the stones separated cleanly, as if unbuilt. The master builder who inspected the wreckage says the runes that bound the stones together have been erased. Not worn away. Erased. As if someone un-spoke the words that held them.', title: 'The Unspoken Bridge', origins: ['dwarf'], frame: { objective: 'Find who or what is erasing the binding runes', crucible: 'A thousand-year bridge unbuilt overnight, and the words that held it are gone from the stone' }, arc: { name: 'The Unspoken Bridge', episode: 'Examine the erased runes and trace the erasure to its source' } },
    ...
    // Seeker
    { hook: 'A map found in a dead adventurer\'s pack leads to a hidden entrance beneath an ancient watchtower. The markings are in a dialect of Old Arcane that was supposed to have died with the Sundering. You can read just enough to know it says "for those who come after."', title: 'For Those Who Come After', classes: ['Seeker'], frame: { objective: 'Enter the watchtower and find what was left for you', crucible: 'A dead language on a map that addresses the future, and a watchtower with a hidden entrance' }, arc: { name: 'For Those Who Come After', episode: 'Translate the map, locate the entrance, and descend' } },
    ...
    // Holdfast
    { hook: 'The garrison at Thornwall hasn\'t sent a rider in two weeks. The road north is open, the weather is clear, and no one will say why they stopped sending reports. The crown wants someone to ride up and find out.', title: 'Silent Garrison', classes: ['Holdfast'], frame: { objective: 'Reach Thornwall and find the garrison', crucible: 'Two weeks of silence from a fortress that should be running normally' }, arc: { name: 'The Silent Garrison', episode: 'Ride to Thornwall and discover why the garrison stopped reporting' } },
    ...
    { hook: 'A book arrives at the Collegium written in a language that changes depending on who reads it. Each scholar sees a different text, and each text is consistent, complete, and contradicts the others. The book is warm to the touch and the pages don\'t age. The Collegium wants to know what the book says. The problem is that the book says something different to everyone who opens it.', title: 'The Changing Book', classes: ['scholar'], frame: { objective: 'Determine what the book actually says and why it shows different texts', crucible: 'A book that tells each reader a different truth, and every version is internally consistent' }, arc: { name: 'The Changing Book', episode: 'Read the book and compare your version to what others report' } },
    { hook: 'The Collegium\'s oldest map, the one that predates every kingdom, has developed a new marking overnight. A symbol has appeared on the Heartlands border that wasn\'t there yesterday. The symbol matches an inscription found in a ruin two hundred miles away. The map is behind glass. Nobody has touched it.', title: 'The Living Map', classes: ['scholar'], frame: { objective: 'Identify the new symbol and travel to its location', crucible: 'An Ancient map that just updated itself, pointing to something the world wasn\'t ready to find' }, arc: { name: 'The Living Map', episode: 'Research the symbol and journey to the coordinates it marks' } },
