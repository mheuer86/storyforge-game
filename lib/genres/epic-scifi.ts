...
**Faction Behavioral Axioms.** Houses: every sentence is a move in a game you may not see. Synod: frames control as care; true believers who stopped asking certain questions. Throne: uses each faction as a check on the other. Undrift: trust earned in actions, never words. Military: duty-first discomfort with ambiguity. Resonants: tired, precise, carrying knowledge they were not meant to have.`,
  ...
  openingHooks: [
    ...
    // ── Spent / Witness ──
    { hook: 'A Synod Hierarch visits your hospice in person with an offer: freedom from the Ward, a protected life, and a question only your unreported Drift-memory can answer. She asks kindly because power can afford kindness when it is alone in the room. The memory kept you alive by staying hidden, and now it can buy freedom only by becoming Synod property.', title: 'The Visitor', origins: ['spent-resonant'], classes: ['Witness'], frame: { objective: 'Decide whether freedom is worth giving the Hierarch a memory the Synod can weaponize', crucible: 'A secret that preserved your life, a life offered in exchange, and the most powerful person you have ever faced asking gently' }, arc: { name: 'The Visitor', episode: 'Make the Hierarch, promised freedom, and hidden memory reveal who would own the answer' } },
