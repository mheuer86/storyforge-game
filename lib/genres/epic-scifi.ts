...
Political stratagems always have a faction clock. The longer the player takes, the more factions adjust their positions. Evidence gets buried, witnesses are transferred, and alliances shift.`,
  ...
  openingHooks: [
    // Universal (4)
    { hook: 'Your house has been allocated a new Resonant. She\'s fourteen. She arrives tomorrow. Your job is to make the transition smooth. Her family hasn\'t stopped sending messages. The Synod says to ignore them.', title: 'The Allocation' },
    { hook: 'A Resonant in your service has stopped responding to attunement. The Synod wants them returned. Your commander wants the problem to disappear quietly. The Resonant is sitting in your quarters, lucid, and asking you not to send them to the Ashen Wards.', title: 'Quiet Disposal' },
    { hook: 'You\'ve been assigned to escort a Synod testing team to a frontier world. The locals have been hiding their children. Your orders are clear. Your conscience is not.', title: 'The Testing' },
    { hook: 'Your house is negotiating a marriage alliance. The dowry isn\'t gold \u2014 it\'s three Resonants from the other house\'s reserve. You\'re the one who has to inspect them and sign the transfer documents.', title: 'The Dowry' },
    // Envoy (3)
    { hook: 'A Major House offers your house a junior seat at the Conclave. The price: your house must publicly support the Synod\'s new Resonant conscription quota, which doubles testing in frontier worlds. Your elders are divided. The decision falls to you.', title: 'The Conclave Seat', classes: ['Envoy'] },
    { hook: 'Two houses signed a trade agreement last season. One just violated it by hiring Undrift Resonants as off-book security. The other wants you to deliver the accusation in open court. If you do, you expose the Undrift network. If you don\'t, your house loses face.', title: 'The Broken Accord', classes: ['Envoy'] },
    { hook: 'You\'ve been sent to negotiate the release of a hostage \u2014 a Resonant child taken by a house that claims they "found" her unregistered. They want recognition for "saving" her from the Undrift. The Synod wants her. The child wants to go home.', title: 'Silent Terms', classes: ['Envoy'] },
    // Knight (3)
    { hook: 'Your garrison has been ordered to hold a Synod processing facility on a world where the locals are openly hiding children from testing. Patrols are finding empty villages. Your soldiers are uncomfortable. The Synod wants results.', title: 'The Garrison', classes: ['Knight'] },
    { hook: 'A frontier settlement is three Resonants short of its annual tithe to the Synod. The settlement elder says two died in a mining accident and one fled. The Synod says the numbers don\'t matter \u2014 the tithe must be met. They\'re looking at the settlement\'s children.', title: 'The Tithe', classes: ['Knight'] },
    { hook: 'You\'ve been assigned to protect a Synod Adjudicator investigating a house accused of harboring Undrift Resonants. The house is your house. The Adjudicator doesn\'t know that yet.', title: 'Shield Duty', classes: ['Knight'] },
    // Seeker (3)
    { hook: 'Your investigation into a frontier heresy cult leads to a Resonant who attuned without Synod training. Impossible, according to doctrine. She\'s coherent, controlled, and says the Drift taught her directly. Your report will either rewrite Synod theology or end her life.', title: 'Doctrinal Anomaly', classes: ['Seeker'] },
    { hook: 'A dead Seeker\'s files arrive on your desk, sealed and redirected three times. Inside: evidence that a senior Synod Hierarch has been falsifying Resonant degradation records for twenty years. The numbers suggest hundreds of Resonants were deployed past safe limits. The Hierarch knows someone has the files.', title: 'The Archive', classes: ['Seeker'] },
    { hook: 'An Undrift cell has been distributing pamphlets claiming the Drift is alive, that Resonants hear it, and that the Synod knows. Your orders are suppression. The problem: you\'ve been hearing it too.', title: 'Heresy or Truth', classes: ['Seeker'] },
    // Conduit (3)
    { hook: 'Your attunement is deepening. You see things in the Drift that the training manuals don\'t describe \u2014 geometries, presences, a pattern that might be language. Your handler wants a report. Reporting accurately means admitting you\'ve crossed a threshold the Synod classifies as hazardous. Not reporting means lying to the institution that controls your deployment.', title: 'The Threshold', classes: ['Conduit'] },
    { hook: 'A Resonant you trained with has been flagged for retirement to the Ashen Wards. She\'s asked you to visit before she\'s transferred. When you arrive, she\'s not degraded at all. She\'s been faking the Dimming because she found something in the Drift and needed to stop being observed.', title: 'Burned Out', classes: ['Conduit'] },
    { hook: 'Your house has developed a new Drift weapon. You\'ve been selected for the attunement calibration. The first test felt wrong \u2014 not dangerous, but aware. Something in the weapon responded to you, and it wasn\'t the technology. The next test is tomorrow.', title: 'Weapon Test', classes: ['Conduit'] },
    // Veil (3)
    { hook: 'You\'ve been inserted into a rival house\'s administrative corps to locate evidence of illegal Resonant breeding programs. Three months in, you\'ve found the evidence. You\'ve also found that the program has produced children who are already attuning, and the house is treating them well. Your handler wants the intel. Delivering it condemns the children to Synod custody.', title: 'The Ledger', classes: ['Veil'] },
    { hook: 'Your cover identity was burned by someone inside your own intelligence service. Not by accident \u2014 deliberately. Someone wants you exposed. You have 48 hours before the house you\'ve infiltrated connects your cover to your real identity, and your handler isn\'t responding to extraction protocols.', title: 'Double Bind', classes: ['Veil'] },
    { hook: 'You witnessed a Synod enforcer kill an Undrift Resonant during what was supposed to be an arrest. The official report says the Resonant attacked first. You know that\'s a lie. Your superiors know you were there. They haven\'t asked for your account.', title: 'The Witness', classes: ['Veil'] },
    // Physik (3)
    { hook: 'A Resonant brought to your clinic has degradation patterns you\'ve never seen. Not the gradual Dimming \u2014 something acute, as if their attunement was forced past capacity in a single event. The Synod says she was in "routine service." Her cellular readings say she was used as a weapon.', title: 'The Patient', classes: ['Physik'] },
    { hook: 'You\'ve been reassigned to an Ashen Ward. Officially: standard medical rotation. Actually: someone in the Synod hierarchy wants a physician who won\'t ask questions. On your first day, you discover that a third of the "spent" Resonants still have measurable attunement. They\'re not burned out. They\'re being hidden.', title: 'The Ward', classes: ['Physik'] },
    { hook: 'Your medical records on Resonant degradation are the most complete outside the Synod\'s own archives. A house intelligence officer offers you protection and resources in exchange for the data. An Undrift cell offers you safe passage for the same data. The Synod offers you a promotion if you\'ll hand the records over and stop keeping your own. All three offers arrived the same day.', title: 'The Record', classes: ['Physik'] },
  ],
