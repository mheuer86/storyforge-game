...
**Faction Behavioral Axioms.** Houses: every sentence is a move in a game you may not see. Synod: frames control as care; true believers who stopped asking certain questions. Throne: uses each faction as a check on the other. Undrift: trust earned in actions, never words. Military: duty-first discomfort with ambiguity. Resonants: tired, precise, carrying knowledge they were not meant to have.`,
  ...
  openingHooks: [
    ...
    // ── Origin-specific hooks ──────────────────────────────────────
    // Synod-Raised (3) — one per playbook archetype
    { hook: 'A frontier district has erupted. Three days of riots after a testing team took eleven children in a single sweep. The Synod\'s administrative corridor is barricaded. The families have armed themselves with mining tools and are refusing to disperse. Your orders: restore order, protect Synod personnel, ensure the testing schedule resumes. The district has four thousand people. You have twelve retainers.', title: 'The Uprising', origins: ['synod-raised'], classes: ['Crusader', 'Knight'], frame: { objective: 'Restore order without a massacre', crucible: 'Twelve retainers against four thousand grieving parents — and the testing schedule must resume' }, arc: { name: 'The Frontier Uprising', episode: 'Assess the situation and choose how to approach the barricade' } },
    { hook: 'A senior Adjudicator has requested your investigation privately. A Synod scholarium has produced three graduates in the last year whose attunement profiles are identical — statistically impossible unless the records were fabricated. The scholarium\'s rector is beloved, politically connected, and has been producing exemplary compliance reports for twenty years. Something in those reports is a lie.', title: 'The Exemplary Rector', origins: ['synod-raised'], classes: ['Censor', 'Seeker'], frame: { objective: 'Determine whether the scholarium\'s records are fabricated', crucible: 'The rector\'s reputation vs. the statistical impossibility — and the Adjudicator who asked you isn\'t telling you everything' }, arc: { name: 'The Scholarium Investigation', episode: 'Review the three graduates\' profiles and identify the discrepancy' } },
    { hook: 'You\'ve been assigned to a frontier intake station for the testing season. Standard rotation. But the physik who preceded you left notes in the margins of the medical log — observations about attunement readings that don\'t match the official results filed with the Synod. She noted seventeen discrepancies before she stopped writing. She was transferred three days later. The intake station expects you tomorrow.', title: 'The Margin Notes', origins: ['synod-raised'], classes: ['Shepherd', 'Physik'], frame: { objective: 'Conduct the intake rotation while investigating the discrepancies', crucible: 'Seventeen children whose readings don\'t match — and the last person who noticed was removed' }, arc: { name: 'The Margin Notes', episode: 'Arrive at the intake station and find the physik\'s medical log' } },
    // Undrift (3) — resistance, extraction, underground
    { hook: 'A child in the next settlement over tested positive three days ago. The Synod assessment team arrives tomorrow. The network has asked you to get the family out before dawn. You have twelve hours, no papers, and a suppression kit that works for six weeks.', title: 'Twelve Hours', origins: ['undrift'], frame: { objective: 'Extract the family before the assessment team arrives', crucible: 'Twelve hours, no papers, and a network that can\'t help if you\'re caught' }, arc: { name: 'The Extraction', episode: 'Get the family out of the settlement and into the underground' }, startingCounters: { exposure: 1 } },
