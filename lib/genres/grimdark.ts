...
**The Old Ruins.** Beneath the provinces, older than any house, are ruins that predate the human settlement of these lands. The Church declares them heretical. The houses want what is inside. The things inside do not care about either. Magic drawn from the ruins is forbidden by the Church, practiced in secret by the houses, and more dangerous than either admits. The Hexblade knows this firsthand.`,
  ...
  openingHooks: [
    ...
    { hook: 'A Sylvara elder has died in a border village. Natural causes. The problem: she was the only person who could verify the land boundaries between three lords, drawn from a century of Sylvara observation records that exist only in her memory. All three lords have already sent surveyors. All three surveys disagree. The village sits on the disputed ground, and the villagers know that whoever draws the line decides whose taxes they pay and whose army protects them. The elder\'s apprentice, a young Thornguard, has a partial copy of the records. Partial. She knows which parts are missing and she knows that two of the three lords would benefit from the gaps. She\'s asking you what to do because you\'re Sylvara, and Sylvara are supposed to know.', title: 'The Memory', origins: ['house-sylvara'], classes: ['Thornguard', 'Arbiter'], frame: { objective: 'Reconstruct the boundary before the lords draw their own', crucible: 'Incomplete records, three competing surveys, and a village that lives or dies by where the line falls' }, arc: { name: 'The Memory', episode: 'Review the partial records with the apprentice and identify what the gaps conceal' } },
    { hook: 'The Church has requested a Sylvara arbiter to mediate a dispute between two monasteries over a relic. Standard ecclesiastical procedure. When you arrive, both monasteries are fortified, the monks are armed, and the relic is a skull that both sides claim speaks to them at night. The skull is real. The speaking may be real. The Sylvara records mention this skull: it was sealed two hundred years ago by a Watcher who noted, in the margin of her report, "Do not arbitrate. Do not adjudicate. Leave." She did not explain why. Both abbots are waiting for your ruling. The skull is in the room between them. It is very quiet.', title: 'The Skull', origins: ['house-sylvara'], classes: ['Arbiter', 'Watcher'], frame: { objective: 'Determine whether the skull is a relic or a threat before ruling on its custody', crucible: 'Two armed monasteries, a two-hundred-year-old warning from your own house, and a skull that may not be inert' }, arc: { name: 'The Skull', episode: 'Examine the Watcher\'s original report and inspect the skull without committing to a ruling' } },
    ...
    { hook: 'A border fortress has been taken by a lord who\'s using it to block trade between two provinces. Your contract: breach the walls and open the road. Standard siege work. Then the scouts report that the lord has filled the fortress with refugees from the Wasting. Three hundred civilians inside the walls, sheltered and fed. The lord is using them as shields. He knows a Stonemark sapper won\'t bring down walls on top of children. He\'s right. The contract doesn\'t mention civilians. The employer doesn\'t care.', title: 'The Fortress', origins: ['house-stonemark'], classes: ['Sapper', 'Holdfast'], frame: { objective: 'Breach the fortress without killing the refugees inside', crucible: 'Three hundred civilians behind the walls you were hired to break, and an employer who considers them acceptable losses' }, arc: { name: 'The Fortress', episode: 'Survey the fortifications and find the refugees\' location inside the walls' } },
    { hook: 'The village paid for protection. Three days in, the captain is dead and the company is being blamed for the raid they were hired to stop. The villagers want blood. The real raiders are still in the hills. And the company is down to seven. You gave your word the village would be safe. The word stands, even if the captain who made the contract is dead, even if the villagers are sharpening tools and looking at your people. A Stonemark word does not die with the speaker.', title: 'Blamed', origins: ['house-stonemark'], classes: ['Holdfast'], frame: { objective: 'Prove the company\'s innocence and honor the contract', crucible: 'Seven fighters, hostile villagers, a dead captain, and an oath that outlives the person who swore it' }, arc: { name: 'Blamed', episode: 'Calm the village and find evidence that clears the company' } },
    ...
    { hook: 'The company has been hired to reinforce a garrison holding a mountain pass. When you arrive, the garrison commander sees your face and reaches for his sword. He lost family in the Wyrm wars. Half the garrison did. They\'d rather lose the pass than fight beside an Ashfang. The enemy force reaches the pass in two days. The garrison is too small to hold without the company. The commander knows this. He\'d still rather die than shake your hand. The soldiers are watching to see what he does, and what you do, and whether the fear in their eyes is the same fear that was in their grandparents\'.', title: 'The Pass', origins: ['house-ashfang'], classes: ['Charblood', 'Exile Voice'], frame: { objective: 'Hold the pass with people who fear you more than the enemy', crucible: 'A garrison that needs you alive and wants you dead, a pass that matters, and two days to turn fear into something functional' }, arc: { name: 'The Pass', episode: 'Assess the garrison\'s defenses and the commander\'s willingness to cooperate' } },
    { hook: 'A Char Dominion ruin has been uncovered by flooding in the southern marches. The Church has declared it sealed. A Veldran expedition has bribed its way past the seal. An Ashfang exile community nearby says the ruin is a tomb, not a treasure vault, and that opening it is a desecration. The Veldran expedition leader offers the company a cut to provide security while they loot it. The exile community elder offers nothing except the truth: what\'s inside the tomb is dangerous, and it was sealed for a reason your ancestors understood and no one else does.', title: 'The Tomb', origins: ['house-ashfang'], classes: ['Ember Scholar', 'Charblood'], frame: { objective: 'Decide who gets access to the Dominion ruin', crucible: 'Veldran money, Church authority, Ashfang memory, and something sealed for a reason no one alive fully understands' }, arc: { name: 'The Tomb', episode: 'Enter the ruin with the Veldran expedition and assess what the Dominion buried there' } },
    // ── Pale Flame (5) — doctrine vs. conscience, moral legitimacy ──
    { hook: 'The church sends you to a remote monastery to investigate reports of heresy. When you arrive, the abbot is cooperative, the brothers are devout, and the chapel is immaculate. Everything is perfect. That\'s the problem — the last investigator sent the same report before he vanished.', title: 'Too Perfect', origins: ['pale-flame'], classes: ['Inquisitor'], frame: { objective: 'Find what the monastery is hiding', crucible: 'Perfect cooperation from people who made the last investigator disappear' }, arc: { name: 'Too Perfect', episode: 'Observe the monastery routines and identify the first crack in the performance' } },
    { hook: 'A condemned man, hours from execution, demands to speak to an inquisitor. Not a priest — an inquisitor. He says his confession will implicate three sitting members of the council. The council says he\'s lying to delay the rope. He says he can prove it, but only to someone with the authority to act.', title: 'The Last Confession', origins: ['pale-flame'], classes: ['Inquisitor'], frame: { objective: 'Hear the confession and judge its truth before the execution', crucible: 'Hours until the rope, a claim against the council, and no time to verify before deciding' }, arc: { name: 'The Last Confession', episode: 'Interrogate the condemned man and assess whether his evidence is real' } },
    { hook: 'A Church-run orphanage in the Wasting zone has been turning away children. The official reason: overcrowding. The unofficial reason reaches you through an Chaplain who can\'t sleep: the Church is triaging. Children from families that tithed are admitted. Children from families that didn\'t are sent back to die. The Chaplain asks whether this is doctrine or murder, and whether there\'s a difference. The bishop who issued the policy is arriving tomorrow to inspect the orphanage. He\'s a good man. He made this decision because the alternative was losing the orphanage entirely.', title: 'The Triage', origins: ['pale-flame'], classes: ['Chaplain', 'Inquisitor'], frame: { objective: 'Decide what to do before the bishop arrives', crucible: 'Children sorted by their parents\' faith, an Chaplain who can\'t bear it, and a bishop whose decision was defensible and devastating' }, arc: { name: 'The Triage', episode: 'Visit the orphanage, meet the children who were turned away, and prepare for the bishop\'s arrival' } },
    { hook: 'A Church district has reported a heresy case: a village healer who claims the Wasting is not divine judgment but a poison, manufactured by someone with access to Church supply routes. The bishop wants the claim suppressed before it spreads. Your orders: investigate the healer, determine whether the claim is heresy or treason, and issue a verdict. The healer is cooperative, articulate, and afraid. She has soil samples, trade manifests, and a map of the Wasting\'s spread that correlates with Church grain shipments. Her evidence is good. If she\'s right, the Church is either complicit or compromised. Your seal gives you the authority to declare her a heretic and end the investigation. It also gives you the authority to follow the evidence. Both are within your mandate. The bishop is expecting a verdict by week\'s end.', title: 'The Verdict', origins: ['pale-flame'], classes: ['Inquisitor'], frame: { objective: 'Investigate the healer\'s claim and issue a verdict', crucible: 'Evidence that implicates the Church, a seal that can bury or expose it, and a bishop waiting for the answer he wants' }, arc: { name: 'The Verdict', episode: 'Examine the healer\'s evidence and determine whether the Wasting correlates with Church supply routes' } },
    { hook: 'A lord\'s keep is under siege by a force carrying the Pale Flame banner. The Church has declared the lord a heretic. Your orders: join the siege, breach the walls, arrest the lord for Inquisition trial. When you arrive, the besieging commander tells you the lord isn\'t resisting because of the heresy charges. He\'s resisting because the Church took his daughter for "religious instruction" three months ago. She hasn\'t been seen since. The commander pauses. "The charges are real. He IS a heretic. But the daughter..." She doesn\'t finish. The walls are thick. The lord has archers. The Flame banner snaps in the wind.', title: 'The Heretic\'s Daughter', origins: ['pale-flame'], classes: ['Crusader', 'Inquisitor'], frame: { objective: 'Take the keep and determine the truth about the lord and his daughter', crucible: 'A legitimate heretic, a missing child, Church authority that may have created the problem it\'s now solving with a siege' }, arc: { name: 'The Heretic\'s Daughter', episode: 'Assess the siege, parley with the lord, and find out what happened to his daughter' } },
    { hook: 'The company is camped outside a city under quarantine. The Church controls access: food in, medicine in, nobody out. You\'ve been assigned to the perimeter. A woman approaches the gate at dawn carrying a child. The child is sick but not with the plague; it\'s a broken arm, badly set. The Church\'s quarantine orders are absolute: no one leaves. The woman says the Church physician inside refused to treat the child because the family hasn\'t tithed. She walked three miles with a child with a broken arm to reach a gate she knows won\'t open. She\'s looking at you because you\'re wearing the Flame, and the Flame is supposed to mean something.', title: 'The Gate', origins: ['pale-flame'], classes: ['Shepherd', 'Crusader'], frame: { objective: 'Decide what the Flame means when doctrine and mercy point in opposite directions', crucible: 'A quarantine, a child with a broken arm, a woman who walked three miles to a closed gate, and your orders' }, arc: { name: 'The Gate', episode: 'Assess whether the quarantine is medical or political, and decide whether to open the gate' } },
  ],
