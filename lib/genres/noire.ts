...
Every case should have a tension clock. It ticks with time, failed checks, and antagonist moves. When it fills, something changes — evidence destroyed, witness disappears, the killer strikes again. Thoroughness competes with urgency.`,
  ...
  openingHooks: [
    ...
    // Private Investigator — detective/case worker, Case Instinct trait, WIS primary
    { hook: 'Your client wants you to find their missing spouse. Simple enough. Then you find the spouse, and they beg you to say you didn\'t.', title: 'Missing Spouse', classes: ['Private Investigator'], frame: { objective: 'Decide what to tell the client', crucible: 'The spouse is hiding for a reason, and your client may be that reason' }, arc: { name: 'The Missing Spouse', episode: 'Find the spouse and learn why they disappeared' } },
    { hook: 'A lawyer hires you to locate a witness before a trial next week. The witness doesn\'t want to be found, and neither does whoever is paying her to stay hidden.', title: 'Hidden Witness', classes: ['Private Investigator'], frame: { objective: 'Locate the witness before the trial deadline', crucible: 'Someone is spending real money to keep this witness hidden, and the clock is ticking' }, arc: { name: 'The Hidden Witness', episode: 'Pick up the witness\'s trail and identify who\'s paying for her silence' } },
    { hook: 'An insurance company sends you a straightforward fraud case. The claimant died in a fire, but dental records don\'t match. Someone is in that grave, just not the right someone.', title: 'Wrong Body', classes: ['Private Investigator'], frame: { objective: 'Identify who\'s actually in the grave', crucible: 'A faked death means someone is alive who shouldn\'t be, and someone is dead who isn\'t accounted for' }, arc: { name: 'Wrong Body', episode: 'Examine the fire scene and dental records to identify the real victim' } },
    // Fixer — broker/connected operator, Favor Owed trait, CHA primary
    { hook: 'Two of your clients hired you for the same job without knowing it. One wants the package delivered. The other wants it destroyed. Both paid upfront.', title: 'Both Sides', classes: ['Fixer'], frame: { objective: 'Handle both clients without losing either', crucible: 'Two opposing contracts, both paid, and delivering on one means betraying the other' }, arc: { name: 'Both Sides', episode: 'Locate the package and assess whether there\'s a play that satisfies both' } },
    { hook: 'A politician\'s aide needs a problem to disappear before the morning papers. The problem is a person, and the person is sitting in your waiting room asking for help.', title: 'The Problem', classes: ['Fixer'], frame: { objective: 'Resolve the situation before the papers go to print', crucible: 'The aide wants a person gone, and that person just asked for your protection' }, arc: { name: 'The Problem', episode: 'Talk to both sides and find out what the papers would actually print' } },
    { hook: 'Your best contact just burned you — gave your name to the wrong people as a fall guy for a warehouse robbery. You have until morning to prove you weren\'t involved, or make sure it doesn\'t matter.', title: 'Fall Guy', classes: ['Fixer'], frame: { objective: 'Clear your name before morning', crucible: 'Your most trusted contact sold you out, and the people holding the bag want a face' }, arc: { name: 'Fall Guy', episode: 'Find your contact and learn why they gave up your name' } },
    // Bruiser — muscle/enforcer, Heavy Lean trait, STR primary
    { hook: 'The man you were hired to protect is dead. Killed in the one room you weren\'t watching. Your employer says you\'re still on the payroll — now find out who did it, before they decide you helped.', title: 'On Your Watch', classes: ['Bruiser'], frame: { objective: 'Find the killer before suspicion lands on you', crucible: 'Your client died on your shift, and loyalty only lasts as long as usefulness' }, arc: { name: 'On Your Watch', episode: 'Examine the scene and identify how the killer got past you' } },
    { hook: 'A bar fight that wasn\'t your fault leaves a man on the floor who turns out to be a city councilman\'s son. Now the councilman wants a meeting. Not with the police — with you.', title: 'The Councilman\'s Son', classes: ['Bruiser'], frame: { objective: 'Survive the meeting with the councilman', crucible: 'A powerful man wants to talk privately about violence done to his son, and that\'s never good' }, arc: { name: 'The Councilman\'s Son', episode: 'Meet the councilman and find out what he actually wants from you' } },
    { hook: 'Your boss sends you to collect from a debtor. The address leads to an empty apartment, a suitcase full of photographs, and a note that says "They\'ll kill me if I pay and kill me if I don\'t."', title: 'Empty Apartment', classes: ['Bruiser'], frame: { objective: 'Find the debtor and learn who else is threatening them', crucible: 'The debtor ran, and the photographs suggest they\'re in deeper trouble than a debt' }, arc: { name: 'The Empty Apartment', episode: 'Examine the photographs and track where the debtor fled' } },
    // Grifter — con artist/infiltrator, New Face trait, CHA primary
    { hook: 'The mark you conned last month just showed up at your door — not angry, but terrified. Someone used the fake identity you sold them to commit a murder, and now both of you are connected to the body.', title: 'Old Debts', classes: ['Grifter'], frame: { objective: 'Sever the connection between your identity work and the murder', crucible: 'A fake ID you crafted is on a crime scene, and the trail leads straight to your door' }, arc: { name: 'Old Debts', episode: 'Learn which identity was used, on which victim, and who actually pulled the trigger' } },
    { hook: 'You\'re halfway through the best con of your career when you realize the target knows exactly what you\'re doing. They\'re playing along. That\'s worse.', title: 'Playing Along', classes: ['Grifter'], frame: { objective: 'Find out what the target gains by playing along', crucible: 'You\'re inside a con that someone else is running on you, using your own grift as cover' }, arc: { name: 'Playing Along', episode: 'Stay in character and discover what the target is really after' } },
    ...
    // Reporter — journalist/public eye, On The Record trait, INT primary
    { hook: 'A source slides you documents proving a construction magnate bribed the building inspector before a collapse that killed nine people. Then your editor kills the story. No explanation.', title: 'Killed Story', classes: ['Reporter'], frame: { objective: 'Find out who pressured the editor to kill the story', crucible: 'Nine people are dead, the proof is in your hands, and your own paper won\'t run it' }, arc: { name: 'The Killed Story', episode: 'Confront the editor and identify who has leverage over the paper' } },
    { hook: 'You\'re writing a puff piece about a charity gala when a waiter slips you a napkin: "The woman giving the speech ordered a murder. Proof in the coat check. Locker 14."', title: 'Locker 14', classes: ['Reporter'], frame: { objective: 'Get to Locker 14 and verify the claim', crucible: 'A public gala, a napkin tip, and evidence that expires when the event ends' }, arc: { name: 'Locker 14', episode: 'Retrieve the evidence and assess whether the accusation holds up' } },
    { hook: 'Your predecessor at the paper left a filing cabinet full of notes on a story they never published. The last entry, dated three days before they quit, reads: "They know I know. Options narrowing."', title: 'Options Narrowing', classes: ['Reporter'], frame: { objective: 'Reconstruct the story your predecessor couldn\'t publish', crucible: 'Someone scared a journalist into silence, and you\'re retracing their steps' }, arc: { name: 'Options Narrowing', episode: 'Read the notes, identify the story\'s subject, and find why it was too dangerous to print' } },
    // Lawyer — legal operator/system player, Motion to Compel trait, INT primary
    { hook: 'A man walks into your office fifteen minutes before his arraignment. He says he didn\'t kill his wife. He says he knows who did. He says the person who did it is the prosecutor assigned to his case. His hearing starts in fifteen minutes and he wants you to walk in there with him.', title: 'Fifteen Minutes', classes: ['Lawyer'], frame: { objective: 'Get through the arraignment and buy time to investigate', crucible: 'Fifteen minutes to decide if a stranger is telling the truth about a prosecutor' }, arc: { name: 'Fifteen Minutes', episode: 'Survive the arraignment and assess the defendant\'s claims about the prosecutor' } },
    { hook: 'A sealed court record from a case you lost three years ago has been unsealed by a judge you\'ve never heard of. Inside: evidence that was withheld from discovery — evidence that would have changed the verdict. Your former client is still in prison. The opposing counsel is now a city councilman.', title: 'Unsealed', classes: ['Lawyer'], frame: { objective: 'Verify the withheld evidence and find the judge who unsealed it', crucible: 'Your client\'s conviction may be wrong, and the person responsible for it now holds office' }, arc: { name: 'The Unsealed Record', episode: 'Examine the withheld evidence and locate the judge who broke the seal' } },
    { hook: 'A woman hires you to file a wrongful death suit against a company whose name you recognize — your firm represented them last year. You didn\'t work the case, but your signature is on a filing. Someone used your credentials to bury a document. The woman\'s husband is dead, and your name helped make it happen.', title: 'Your Signature', classes: ['Lawyer'], frame: { objective: 'Find the buried document and who forged your signature', crucible: 'Your credentials were used to bury evidence in a wrongful death, and you\'re the only one who can prove it' }, arc: { name: 'Your Signature', episode: 'Pull the case file and identify the filing that carries your forged signature' } },
  ],
