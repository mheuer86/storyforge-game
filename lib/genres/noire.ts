...
**Unwritten Rules.** Cops don't investigate upward. Reporters don't name sources. Lawyers don't cross certain clients. Criminals don't touch certain families. Everyone knows where the lines are. The people who cross them end up in the river, in a cell, or in a story that nobody prints.`,
  ...
  openingHooks: [
    ...
    { hook: 'Someone is killing people connected to a trial that happened twenty years ago. You were a witness. The police have not warned you, the killer has not contacted you, and that silence means somebody needs you alive, ignorant, or easy to blame.', title: 'The Witness List', frame: { objective: 'Expose who is using the old trial before your survival becomes part of their design', crucible: 'You are on the list, and being skipped may be more dangerous than being hunted' }, arc: { name: 'The Witness List', episode: 'Make the first surviving witness, police silence, and old verdict reveal why you were left untouched' } },
    ...
    // Desperate
    { hook: 'A woman reaches your office at midnight with a black eye and a photograph of the police captain she says will kill her. She cannot afford your rate; she has forty-three marks and a rosary. A Desperate investigator knows the captain counts on price, badge, and shame doing his work before he has to.', title: 'Forty-Three Marks', origins: ['pi'], classes: ['Desperate'], frame: { objective: 'Decide how to make the captain vulnerable when the client can pay only with trust and fear', crucible: 'A client nobody profitable will protect and a police captain whose power starts with being untouchable' }, arc: { name: 'Forty-Three Marks', episode: 'Make the woman, captain, and first unsafe refuge reveal what protection will cost' } },
