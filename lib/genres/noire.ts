...
**Unwritten Rules.** Cops don't investigate upward. Reporters don't name sources. Lawyers don't cross certain clients. Criminals don't touch certain families. Everyone knows where the lines are. The people who cross them end up in the river, in a cell, or in a story that nobody prints.`,
  ...
  openingHooks: [
    // ── Universal Hooks ─────────────────────────────────────────────────
    { hook: 'A woman you\'ve never met left your name in her will. She died yesterday. The inheritance is a locked box and a list of five names — four of them are still alive. The executor wants the box surrendered, the cops want to know why a dead woman chose you, and someone connected to the list is already trying to make the inheritance look like motive.', title: 'Five Names', frame: { objective: 'Learn why the dead woman made you responsible for the names before another one disappears', crucible: 'A stranger trusted you with a box, and every living name turns evidence into obligation' }, arc: { name: 'Five Names', episode: 'Use the first living name to learn who wants the box in official hands and who wants it gone' } },
    { hook: 'Someone is killing people connected to a trial that happened twenty years ago. You were a witness. The police have not warned you, the killer has not contacted you, and that silence means somebody needs you alive, ignorant, or easy to blame.', title: 'The Witness List', frame: { objective: 'Expose who is using the old trial before your survival becomes part of their design', crucible: 'You are on the list, and being skipped may be more dangerous than being hunted' }, arc: { name: 'The Witness List', episode: 'Find the first surviving witness before police silence and the old verdict explain why you were left untouched' } },
    ...
    { hook: 'A stranger leaves a decade-old missing teenager file on your doorstep, closed by a detective who retired the next year. The teenager\'s name appears in yesterday\'s police blotter under a different surname. Whoever reopened the file chose a PI instead of the police because the police may be part of what kept the girl missing.', title: 'The Cold File', origins: ['pi'], frame: { objective: 'Expose who needed the girl to stay missing and why they are letting her name surface now', crucible: 'A cold case delivered to your door, a living name in police ink, and a retired detective whose closure may have been protection or burial' }, arc: { name: 'The Cold File', episode: 'Take the current arrest to the retired detective and anonymous file before the past closes again' } },

    // The Machine — operating the system's machinery
    { hook: 'A man walks into your office fifteen minutes before his arraignment. He says he didn\'t kill his wife. He says he knows who did. He says the killer is the prosecutor assigned to his case. He does not need a form filed; he needs someone inside the machine to make the machine hesitate. Walking in with him makes you visible to a prosecutor who may already own the room.', title: 'Fifteen Minutes', origins: ['the-machine'], frame: { objective: 'Risk the court machine against itself long enough to learn whether the prosecutor is predator or bait', crucible: 'A stranger points at the person holding state power over him, and you have minutes to decide whether to stand beside him' }, arc: { name: 'Fifteen Minutes', episode: 'Use the arraignment to expose who controls the room before the case moves without you' } },
    { hook: 'A woman hires you for a wrongful death case against a company whose name you recognize — your firm represented them last year. You didn\'t work the case, but your signature is on a filing that helped bury a document. Someone used your credentials to make evidence disappear, and the widow has come to the one person whose reputation can reopen the wound or finish covering it.', title: 'Your Signature', origins: ['the-machine'], startingCounters: { complicity: 2 }, frame: { objective: 'Expose who used your credentials to bury a death before the widow\'s case buries you', crucible: 'Your name helped hide evidence, and proving the forgery means admitting how useful your name was' }, arc: { name: 'Your Signature', episode: 'Put the widow, old firm, and buried filing in tension before deciding who gets your protection' } },
    ...
    { hook: 'You\'re hired to move a crate across town, no questions. Halfway there, the crate breathes: a sedated person in expensive clothes and a wedding ring. Your employer bought your silence, someone powerful is missing a spouse, and the breathing cargo can turn a delivery job into kidnapping, rescue, or blackmail depending who reaches you first.', title: 'The Crate', origins: ['criminal'], frame: { objective: 'Decide who gets the living cargo before employer, spouse, or law makes the choice for you', crucible: 'Good money, a lied-about body, and a job whose terms changed when the cargo breathed' }, arc: { name: 'The Living Cargo', episode: 'Open the crate\'s truth before employer, spouse, or law claims delivery' } },

    // Enforcer — maintaining order through force
    { hook: 'The man you were hired to protect is dead, killed in the one room you weren\'t watching. Your employer says you are still on payroll, which means you are still useful until they need a fall guy. Someone designed the death around your blind spot, and everyone left alive knows it.', title: 'On Your Watch', origins: ['enforcer'], frame: { objective: 'Expose who turned your protection into cover before your employer turns you into the answer', crucible: 'A dead client, a deliberate blind spot, and loyalty that lasts only while blame needs somewhere else to land' }, arc: { name: 'On Your Watch', episode: 'Return to the blind room with employer and first suspect before your watch becomes the explanation' } },
    ...
    // Methodical
    { hook: 'A lawyer hires you to locate a witness before a trial next week. The witness doesn\'t want to be found, and neither does whoever is paying her to stay hidden. A Methodical PI can follow a trail, but the question is why everyone with money wants this woman either in court or invisible, and whether your client deserves the truth they hired you to uncover.', title: 'Hidden Witness', origins: ['pi'], classes: ['Methodical'], frame: { objective: 'Find why the witness is worth hiding and whether your client deserves her', crucible: 'Someone is paying for silence, someone is paying you to break it, and the witness may be safer from both' }, arc: { name: 'The Hidden Witness', episode: 'Use the first trail to test what your client will do if the witness tells the wrong truth' } },
    { hook: 'An insurance company sends a Methodical PI a clean fraud case: the claimant died in a fire, but dental records do not match. Someone is in that grave, just not the claimant. The insurer wants denial, a family wants money, and the wrong body may be the only person in the case who cannot lie.', title: 'Wrong Body', origins: ['pi'], classes: ['Methodical'], frame: { objective: 'Decide who benefits from the wrong body before fraud becomes the easiest story', crucible: 'A grave with one truth in it, an insurer hungry for denial, and a missing claimant who may be victim or architect' }, arc: { name: 'Wrong Body', episode: 'Put insurer, family, and unidentified body at the grave before fraud becomes the easiest story' } },

    // Street PI
    { hook: 'Your client wants you to find their missing spouse. Simple enough. Then you find the spouse, and they beg you to say you didn\'t.', title: 'Missing Spouse', origins: ['pi'], classes: ['Street PI'], frame: { objective: 'Decide what to tell the client', crucible: 'The spouse is hiding for a reason, and your client may be that reason' }, arc: { name: 'The Missing Spouse', episode: 'Find the spouse and learn why they disappeared' } },

    // Grifter
    { hook: 'A dying man gives you a key and a name. The name is fake — you know because you invented it three years ago for a job you thought was finished. Someone has been spending that name like real currency, and the man dies before he can tell you whether he was warning you, paying you, or setting you up.', title: 'A Name You Made', origins: ['criminal'], classes: ['Grifter'], frame: { objective: 'Find who turned your false name into power and what the key makes you responsible for', crucible: 'Your old lie has become someone else\'s life, and a dying man chose you to inherit the consequences' }, arc: { name: 'A Name You Made', episode: 'Use the key and the fake name to learn who profits from your unfinished con' } },

    // Mobster
    { hook: 'Two of your clients hired you for the same job without knowing it. One wants the package delivered. The other wants it destroyed. Both paid upfront, and each one knows enough about your operation to hurt you if you choose badly. Whatever is inside the package is less dangerous than what the two clients are trying to make you prove.', title: 'Both Sides', origins: ['criminal'], classes: ['Mobster'], frame: { objective: 'Turn two opposing clients against the trap before either makes you disposable', crucible: 'Two debts paid in advance, two loyalties claimed, and one package designed to force your hand' }, arc: { name: 'Both Sides', episode: 'Play each client against the package\'s fate before either makes you disposable' } },
    { hook: 'Your best contact gave your name to the wrong people as the fall guy for a warehouse robbery. By morning, someone will need a face for the loss. The contact knew what your name was worth, and a Mobster knows betrayal is rarely personal when debt can make it useful.', title: 'Fall Guy', origins: ['criminal'], classes: ['Mobster'], frame: { objective: 'Turn the setup back on whoever bought your contact before the robbery needs a body attached', crucible: 'A trusted contact selling your name and a crew that wants blame more than truth' }, arc: { name: 'Fall Guy', episode: 'Confront the contact with robbery crew and missing goods before your name fits the frame' } },

    // Cop
    { hook: 'A bar fight that wasn\'t your fault leaves a man on the floor who turns out to be a city councilman\'s son. The councilman wants a meeting with you, not the police. A Cop knows that private outrage from public power is never only about the son; it is about who gets to write the report without filing one.', title: 'The Councilman\'s Son', origins: ['enforcer'], classes: ['Cop'], frame: { objective: 'Expose what the councilman wants your badge or fists to make disappear', crucible: 'A powerful father, a public injury, and a private meeting designed to move violence off the record' }, arc: { name: 'The Councilman\'s Son', episode: 'Take the private meeting and force the councilman to say what the absent report should erase' } },

    // Private Muscle
    { hook: 'Your boss sends you to collect from a debtor. The apartment is empty except for photographs and a note: "They\'ll kill me if I pay and kill me if I don\'t." Your boss wants money, someone else wants silence, and Private Muscle becomes disposable the moment muscle asks why a debt got this crowded.', title: 'Empty Apartment', origins: ['enforcer'], classes: ['Private Muscle'], frame: { objective: 'Decide whether the debt belongs to your boss, the missing debtor, or whoever turned payment into a death sentence', crucible: 'An empty apartment, a frightened note, and a collection job that makes force look too simple' }, arc: { name: 'The Empty Apartment', episode: 'Search the photographs and debtor warning before your boss can turn collection into the only answer' } },

    // Investigative Journalist
    { hook: 'You\'re writing a puff piece about a charity gala when a waiter slips you a napkin: "The woman giving the speech ordered a murder. Proof in the coat check. Locker 14." The gala handlers want the night to stay spotless, your editor wants access to the donors, and whoever sent the napkin wants a reporter to make the first dangerous move.', title: 'Locker 14', origins: ['reporter'], classes: ['Investigative Journalist'], frame: { objective: 'Expose why the accusation reached you before the gala machine can turn it into scandal or silence', crucible: 'A public room full of donors, a murder claim in your pocket, and sources who may be using your byline as a weapon' }, arc: { name: 'Locker 14', episode: 'Force the tipster, the handlers, or the accused patron to reveal who benefits if Locker 14 opens' } },

    // Defense Attorney
    { hook: 'A sealed court record from a case you lost three years ago has been opened by a judge you\'ve never heard of. Inside: evidence that would have changed the verdict. Your former client is still in prison, the opposing counsel is now a city councilman, and somebody in the courthouse wants the record loose only after it can ruin you as well as him.', title: 'Unsealed', origins: ['the-machine'], classes: ['Defense Attorney'], frame: { objective: 'Use the unsealed evidence to free your client without becoming the scandal that buries it again', crucible: 'A wrongful conviction, a powerful former opponent, and a record released by someone with their own timing' }, arc: { name: 'The Unsealed Record', episode: 'Use the record to pressure your client, the councilman, and the unknown judge before scandal buries it again' } },

    // Fixer Lawyer
    { hook: 'A politician\'s aide needs a problem to disappear before morning papers. The problem is a person, and that person is in your waiting room asking for help. As a Fixer Lawyer, you know disappearance can mean protection, payout, exile, or murder, and the aide is betting you will choose the tidy definition.', title: 'The Problem', origins: ['criminal'], classes: ['Fixer Lawyer'], frame: { objective: 'Decide whether to protect the person, the politician, or your own leverage before the papers give everyone a deadline', crucible: 'A human being named as a problem and a political machine asking you to make language true' }, arc: { name: 'The Problem', episode: 'Face the aide and person in your waiting room before the threatened story defines disappear' } },

    // Prosecutor Turned
    { hook: 'Your predecessor at the DA\'s office left a filing cabinet in storage. Inside: case notes on a prosecution they never brought. The last entry, dated three days before they resigned, reads: "They know I know. Options narrowing." The case number matches an open investigation, and someone inside the office has already warned you to leave old work alone.', title: 'Options Narrowing', origins: ['the-machine'], classes: ['Prosecutor Turned'], frame: { objective: 'Find who narrowed your predecessor\'s options before the same pressure closes around you', crucible: 'The office you left still knows how to use law as a leash, and the case is open enough to pull you back in' }, arc: { name: 'Options Narrowing', episode: 'Use the old notes to test which colleague, target, or institution still fears the buried prosecution' } },

    // Desperate
    { hook: 'A woman reaches your office at midnight with a black eye and a photograph of the police captain she says will kill her. She cannot afford your rate; she has forty-three marks and a rosary. A Desperate investigator knows the captain counts on price, badge, and shame doing his work before he has to.', title: 'Forty-Three Marks', origins: ['pi'], classes: ['Desperate'], frame: { objective: 'Decide how to make the captain vulnerable when the client can pay only with trust and fear', crucible: 'A client nobody profitable will protect and a police captain whose power starts with being untouchable' }, arc: { name: 'Forty-Three Marks', episode: 'Get the woman to the first unsafe refuge while the captain\'s reach prices protection' } },

    // Thief
    { hook: 'A fence asks you to steal a painting from a private collection. Easy job — the security is old, the owner is out of town. You get inside, find the painting, and see that someone has already cut it from the frame. Behind the canvas, taped to the stretcher bars, is a photograph of a girl and a handwritten note: "If this painting leaves the house, she dies." The fence didn\'t mention any of this. The owner gets home tomorrow.', title: 'Behind the Canvas', origins: ['criminal'], classes: ['Thief'], frame: { objective: 'Decide what to do with the painting and the threat behind it', crucible: 'A routine theft became a hostage situation, and the fence who sent you knew what was behind the canvas' }, arc: { name: 'Behind the Canvas', episode: 'Identify the girl in the photograph and find out why the painting is worth a life' } },

    // Community Protector
    { hook: 'Three buildings on your block get eviction notices on the same morning from a holding company nobody can find. The tenants have thirty days, a grandmother upstairs says she is not leaving, and the company lawyer says paper can erase a neighborhood before anyone finds a human face to blame.', title: 'Thirty Days', origins: ['enforcer'], classes: ['Community Protector'], frame: { objective: 'Decide how to make a faceless company answer to the neighborhood before eviction turns memory into vacancy', crucible: 'A block being erased by paperwork and people counting on you because the law cannot see them' }, arc: { name: 'Thirty Days', episode: 'Bring tenants and company lawyer face to face while the hidden owner prices the block alive' } },

    // Columnist
    { hook: 'Your column about a councilman\'s suspicious land deals runs Tuesday. By Thursday he endorses it as proof of transparency, turning your exposé into a campaign ad. The facts are right, your framing failed, and the sources who risked themselves for you now think your words made him stronger.', title: 'The Backfire', origins: ['reporter'], classes: ['Columnist'], frame: { objective: 'Decide how to take back the story without burning the sources whose trust you already spent', crucible: 'True facts weaponized by their target and sources who may not survive another clever angle' }, arc: { name: 'The Backfire', episode: 'Take the next publishable fact to councilman and furious sources before another angle gets weaponized' } },

    // Information Broker
    { hook: 'Six months ago you killed a story about a judge for a price you do not regret. This morning the same story lands on every editor\'s desk under your byline. The judge thinks you published, the buyer thinks you double-crossed them, and someone resurrected what you buried because your name makes the betrayal profitable.', title: 'The Resurrection', origins: ['reporter'], classes: ['Information Broker'], frame: { objective: 'Expose who put your name on the resurrected story before both sides make blame useful', crucible: 'A buried truth, a bought silence, and a byline that turns your old bargain into current danger' }, arc: { name: 'The Resurrection', episode: 'Trace the resurrected story through judge and buyer before your byline becomes the only betrayal' } },
    ...
    { hook: 'A witness changes their story between the first sentence and the third without noticing. The first version implicates someone with an office downtown; the revised version implicates nobody. Whoever coached the correction did not erase the truth, just taught fear to speak faster than memory.', title: 'The Revised Story', origins: ['pi', 'the-machine', 'enforcer', 'reporter'], classes: ['investigator'], frame: { objective: 'Expose who trained the witness to protect power before the revised story becomes official truth', crucible: 'A witness lying without knowing it and a first version that points upward' }, arc: { name: 'The Revised Story', episode: 'Hold the witness to the corrected phrase and downtown office before the third sentence becomes official' } },

    // operator — Methodical, Defense Attorney, Fixer Lawyer, Prosecutor, Columnist
    { hook: 'A city clerk offers you a trade: a file for a file. Hers proves a building inspector\'s negligence killed three people. The file she wants is yours, and it proves the inspector was following orders. She wants justice. She\'s willing to make you complicit to get it.', title: 'The Trade', origins: ['pi', 'the-machine', 'criminal', 'reporter'], classes: ['operator'], frame: { objective: 'Decide whether the trade serves justice or just shifts the blame', crucible: 'Two files, two truths, and a clerk who needs your hands as dirty as hers' }, arc: { name: 'The File Trade', episode: 'Examine her file and assess what giving up yours would mean' } },
    { hook: 'A sealed deposition from a settled case surfaces after ten years, naming six people, four now elected. The person who broke the seal demands a public meeting at the courthouse steps. An operator knows that choosing public ground is not transparency; it is leverage staged where every institution must decide whether to look.', title: 'The Deposition', origins: ['pi', 'the-machine', 'criminal', 'reporter'], classes: ['operator'], frame: { objective: 'Decide who is using the deposition\'s release before public truth becomes someone else\'s trap', crucible: 'Four politicians named, a source staging visibility, and an old settlement that powerful people paid to end' }, arc: { name: 'The Broken Seal', episode: 'Meet the source on the courthouse steps while named officials and public audience decide whether to look' } },

    // infiltrator — Grifter, Thief, Information Broker
    { hook: 'Someone is living under an identity you built and discarded three years ago. They\'ve improved on the original: better paper trail, better social history. The identity is now married, employed, and under investigation for embezzlement. Your craft is being used, and it\'s being used badly.', title: 'The Stolen Face', origins: ['criminal', 'reporter'], classes: ['infiltrator'], frame: { objective: 'Find who is using the identity and sever the connection to you', crucible: 'Your work is on a suspect, and the investigation will trace the identity back to its maker' }, arc: { name: 'The Stolen Face', episode: 'Research the identity\'s current life and find out who inherited your work' } },
    { hook: 'A train station lockbox holds a key, a photograph of you taken yesterday, and a note: "The people in the photograph behind yours will kill you Thursday. The key opens the place where they\'ll try." The next photograph shows a family of four. Someone unseen is spending fear like a map, and the family may be warning, bait, or collateral.', title: 'Thursday', origins: ['criminal', 'reporter'], classes: ['infiltrator'], frame: { objective: 'Decide whether the key is rescue, trap, or invitation before Thursday makes the unseen watcher right', crucible: 'A photographed threat, a family placed behind you, and a key from someone close enough to prove they can reach you' }, arc: { name: 'Thursday', episode: 'Use the key against the family photo and unseen watcher before Thursday decides who moves first' } },

    // muscle — Desperate, Thief, Mobster, Cop, Private Muscle, Community Protector
    { hook: 'A neighborhood priest asks you to stand outside his church on Sunday. Just be visible. He won\'t say why. Four men in a car see you and leave. Monday, the car burns. Tuesday, the priest is gone. Wednesday, one of the four men shows up at your door. He isn\'t angry. He\'s asking for help.', title: 'The Priest', origins: ['pi', 'criminal', 'enforcer'], classes: ['muscle'], frame: { objective: 'Find the priest and learn what the four men wanted', crucible: 'A disappeared priest, a burned car, and an enemy who arrived asking for help instead of revenge' }, arc: { name: 'The Priest\'s Absence', episode: 'Talk to the man at your door and trace where the priest went' } },
    { hook: 'A woman hires you to walk her home from work every night for a week. She pays in cash, doesn\'t explain, and takes a different route each time. On the fifth night, she stops walking and points to a window three stories up. "That\'s where he watches from." The window is dark, but the curtain moves.', title: 'The Walk Home', origins: ['pi', 'criminal', 'enforcer'], classes: ['muscle'], frame: { objective: 'Identify the watcher and decide what to do about them', crucible: 'Five nights of silence, one pointed finger, and a window where someone has been waiting' }, arc: { name: 'The Watcher', episode: 'Investigate the building and identify who lives behind the window' } },

    // networker — Street PI, Fixer Lawyer, Mobster, Community Protector, Columnist, Information Broker
    { hook: 'Two reliable informants give contradictory accounts of the same night. Both are frightened, both are telling the truth, which means someone staged the event twice for two audiences. A networker knows the staging is less important than why each source was meant to carry a different reality back to you.', title: 'Two Truths', origins: ['pi', 'the-machine', 'criminal', 'enforcer', 'reporter'], classes: ['networker'], frame: { objective: 'Expose who staged two truths and what they expected your network to do with them', crucible: 'Two trusted sources, two real events, and a manipulator treating your contacts as delivery channels' }, arc: { name: 'The Staged Event', episode: 'Put both informants and the first shared detail together before your network carries the wrong truth' } },
  ],
