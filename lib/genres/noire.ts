...
**Unwritten Rules.** Cops don't investigate upward. Reporters don't name sources. Lawyers don't cross certain clients. Criminals don't touch certain families. Everyone knows where the lines are. The people who cross them end up in the river, in a cell, or in a story that nobody prints.`,
  ...
  openingHooks: [
    ...
    // Grifter
    { hook: 'A dying man gives you a key and a name. The name is fake — you know because you invented it three years ago for a job you thought was finished.', title: 'A Name You Made', origins: ['criminal'], classes: ['Grifter'], frame: { objective: 'Find what the key opens', crucible: 'An identity you created took on a life of its own, and someone just died for it' }, arc: { name: 'A Name You Made', episode: 'Trace the dying man\'s connection to the identity and find the lock that fits the key' } },

    // Mobster
    { hook: 'Two of your clients hired you for the same job without knowing it. One wants the package delivered. The other wants it destroyed. Both paid upfront.', title: 'Both Sides', origins: ['criminal'], classes: ['Mobster'], frame: { objective: 'Handle both clients without losing either', crucible: 'Two opposing contracts, both paid, and delivering on one means betraying the other' }, arc: { name: 'Both Sides', episode: 'Locate the package and assess whether there\'s a play that satisfies both' } },
    { hook: 'Your best contact just burned you — gave your name to the wrong people as a fall guy for a warehouse robbery. You have until morning to prove you weren\'t involved, or make sure it doesn\'t matter.', title: 'Fall Guy', origins: ['criminal'], classes: ['Mobster'], frame: { objective: 'Clear your name before morning', crucible: 'Your most trusted contact sold you out, and the people holding the bag want a face' }, arc: { name: 'Fall Guy', episode: 'Find your contact and learn why they gave up your name' } },

    // Cop
    { hook: 'A bar fight that wasn\'t your fault leaves a man on the floor who turns out to be a city councilman\'s son. Now the councilman wants a meeting. Not with the police — with you.', title: 'The Councilman\'s Son', origins: ['enforcer'], classes: ['Cop'], frame: { objective: 'Survive the meeting with the councilman', crucible: 'A powerful man wants to talk privately about violence done to his son, and that\'s never good' }, arc: { name: 'The Councilman\'s Son', episode: 'Meet the councilman and find out what he actually wants from you' } },

    // Private Muscle
    { hook: 'Your boss sends you to collect from a debtor. The address leads to an empty apartment, a suitcase full of photographs, and a note that says "They\'ll kill me if I pay and kill me if I don\'t."', title: 'Empty Apartment', origins: ['enforcer'], classes: ['Private Muscle'], frame: { objective: 'Find the debtor and learn who else is threatening them', crucible: 'The debtor ran, and the photographs suggest they\'re in deeper trouble than a debt' }, arc: { name: 'The Empty Apartment', episode: 'Examine the photographs and track where the debtor fled' } },

    // Investigative Journalist
    { hook: 'You\'re writing a puff piece about a charity gala when a waiter slips you a napkin: "The woman giving the speech ordered a murder. Proof in the coat check. Locker 14."', title: 'Locker 14', origins: ['reporter'], classes: ['Investigative Journalist'], frame: { objective: 'Get to Locker 14 and verify the claim', crucible: 'A public gala, a napkin tip, and evidence that expires when the event ends' }, arc: { name: 'Locker 14', episode: 'Retrieve the evidence and assess whether the accusation holds up' } },

    // Defense Attorney
    { hook: 'A sealed court record from a case you lost three years ago has been unsealed by a judge you\'ve never heard of. Inside: evidence that was withheld from discovery — evidence that would have changed the verdict. Your former client is still in prison. The opposing counsel is now a city councilman.', title: 'Unsealed', origins: ['the-machine'], classes: ['Defense Attorney'], frame: { objective: 'Verify the withheld evidence and find the judge who unsealed it', crucible: 'Your client\'s conviction may be wrong, and the person responsible for it now holds office' }, arc: { name: 'The Unsealed Record', episode: 'Examine the withheld evidence and locate the judge who broke the seal' } },

    // Fixer Lawyer
    { hook: 'A politician\'s aide needs a problem to disappear before the morning papers. The problem is a person, and the person is sitting in your waiting room asking for help.', title: 'The Problem', origins: ['criminal'], classes: ['Fixer Lawyer'], frame: { objective: 'Resolve the situation before the papers go to print', crucible: 'The aide wants a person gone, and that person just asked for your protection' }, arc: { name: 'The Problem', episode: 'Talk to both sides and find out what the papers would actually print' } },

    // Prosecutor Turned
    { hook: 'Your predecessor at the DA\'s office left a filing cabinet in storage. Inside: case notes on a prosecution they never brought. The last entry, dated three days before they resigned, reads: "They know I know. Options narrowing." The case number matches an open investigation.', title: 'Options Narrowing', origins: ['the-machine'], classes: ['Prosecutor Turned'], frame: { objective: 'Reconstruct the case your predecessor couldn\'t prosecute', crucible: 'Someone inside the DA\'s office was scared into silence, and you recognize the case number' }, arc: { name: 'Options Narrowing', episode: 'Read the case notes, identify the target, and find why the prosecution was buried' } },

    // Desperate
    { hook: 'A woman shows up at your office at midnight with a black eye and a photograph of a man she says is going to kill her. She can\'t go to the police because the man in the photograph is a police captain. She can\'t afford your rate. She can afford what\'s in her purse: forty-three marks and a rosary.', title: 'Forty-Three Marks', origins: ['pi'], classes: ['Desperate'], frame: { objective: 'Protect the woman and find leverage against the captain', crucible: 'A case nobody else will take, a client who can\'t pay, and the kind of man who counts on that' }, arc: { name: 'Forty-Three Marks', episode: 'Get the woman safe and start building a case with no resources and no allies' } },
    ...
    { hook: 'A sealed deposition surfaces in a case that was settled out of court ten years ago. The deposition names six people. Four are now in elected office. The person who broke the seal wants a meeting — tomorrow, in public, at the courthouse steps.', title: 'The Deposition', origins: ['pi', 'the-machine', 'criminal', 'reporter'], classes: ['operator'], frame: { objective: 'Meet the source and assess what they want before the deposition goes wider', crucible: 'A decade-old secret, four politicians named, and a source who chose the courthouse steps for a reason' }, arc: { name: 'The Broken Seal', episode: 'Read the deposition and prepare for the meeting' } },
