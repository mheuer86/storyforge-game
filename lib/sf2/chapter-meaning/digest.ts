...
export interface Sf2MeaningDigestItem {
  id: string
  label: string
  detail: string
  turn?: number
...
export interface Sf2MeaningDigestCandidate {
  chapter: number
  situation: string
  tension: string
  ticking: string
  ...
  evidence: {
    activeThreads: Sf2MeaningDigestItem[]
    resolvedThreads: Sf2MeaningDigestItem[]
    promises: Sf2MeaningDigestItem[]
    decisions: Sf2MeaningDigestItem[]
    npcMovements: Sf2MeaningDigestItem[]
    factionMovements: Sf2MeaningDigestItem[]
    hardFacts: Sf2MeaningDigestItem[]
    unresolvedPressures: Sf2MeaningDigestItem[]
    recentTurns: Sf2MeaningDigestItem[]
  }
  compactSummary: string
}

export interface Sf2MeaningDigestOptions {
...
export function buildMeaningDigestCandidate(
  state: Sf2State,
  options: Sf2MeaningDigestOptions = {}
): Sf2MeaningDigestCandidate {
...
function deriveHardFacts(state: Sf2State, maxItems: number): Sf2MeaningDigestItem[] {
  const facts: Sf2MeaningDigestItem[] = []
...
function deriveUnresolvedPressures(
  ...
  maxItems: number
): Sf2MeaningDigestItem[] {
  const pressureItems: Sf2MeaningDigestItem[] = activeThreads.map((thread) => ({
    id: thread.id,
    label: thread.title,
...
function threadToDigestItem(thread: Sf2Thread): Sf2MeaningDigestItem {
  return {
    id: thread.id,
    label: thread.title,
...
function promiseToDigestItem(promise: Sf2Promise): Sf2MeaningDigestItem {
  return {
    id: promise.id,
    label: promise.title,
...
function decisionToDigestItem(decision: Sf2Decision): Sf2MeaningDigestItem {
  return {
    id: decision.id,
...
function npcToDigestItem(npc: Sf2Npc): Sf2MeaningDigestItem {
...
function factionToDigestItem(faction: Sf2Faction): Sf2MeaningDigestItem {
...
function topFactionMove(items: Sf2MeaningDigestItem[]): Sf2MeaningDigestItem | undefined {
  return items[0]
}
