    ...
    properties: {
      ...
      updates: {
        ...
        items: {
          type: 'object',
          properties: {
            entity_kind: { type: 'string', enum: ['npc', 'faction', 'thread', 'arc', 'clue', 'document', 'operation_plan', 'procedure'] },
      ...
      transitions: {
        ...
        items: {
          ...
          properties: {
            entity_kind: {
              type: 'string',
              enum: ['thread', 'decision', 'promise', 'clue', 'arc', 'document', 'procedure'],
            },
