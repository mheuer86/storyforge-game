...
| `tensionScore` | planning | Chapter Author planning artifact, mainly SF2B continuation scoring; it is not canonical thread urgency. | `lib/sf2/types.ts`, `lib/sf2/author/tools.ts` | `role: foreground_objective`, `pressure: "buyer controls the handoff"` |
